      ...
      <div className="container">
        ...
        {upcomingEpisodes.length >= 1 && !loading && !error ? (
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.4, ease: 'easeOut' }}
            className="bg-dark/50 backdrop-blur-sm rounded-2xl border-2 border-white/60 p-8 max-w-4xl mx-auto mb-16 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-white/30 hover:bg-dark/60 shadow-xl shadow-white/20"
          >
