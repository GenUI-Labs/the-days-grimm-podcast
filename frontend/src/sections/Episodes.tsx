      ...
      <div className="container">
        ...
        {upcomingEpisodes.length >= 1 && !loading && !error ? (
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.4, ease: 'easeOut' }}
            className="bg-dark/50 backdrop-blur-sm rounded-2xl border-4 border-white/80 p-8 max-w-4xl mx-auto mb-16 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-black/50 hover:bg-dark/60 shadow-lg shadow-black/40"
          >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-6 sm:gap-8 mb-10 sm:mb-12">
          {recentEpisodes.map((episode, index) => (
            <div
              ...
              className="bg-dark/50 backdrop-blur-sm rounded-2xl border-4 border-white/80 p-6 relative overflow-hidden flex flex-col text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-black/50 hover:bg-dark/60 shadow-lg shadow-black/40"
            >
